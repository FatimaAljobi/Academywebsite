...
<nav class="navbar navbar-expand-lg navbar-light bg-ligh" style= "background-color: #dcdce0; ">
    <div class="container-fluid" style="padding: 0px;">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav" style=" font-weight: bold;  font-family:Muslimah; font-size: 20px; margin-left: 20px; margin-right: 250px;">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Language & Translation Services.php" style="color:#050569;">Language & Translation Services</a>
          </li>
        ...
        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" style="" >
          <input type="search" class="form-control form-control-dark" placeholder="Search..." aria-label="Search">
        </form>

        <!-- Sign in button -->
        <div class="text-end">
          <button type="button" class="btn" style="width:80px; height: 39px; background-color: #050569; "> <a href="" style="text-decoration: none; color:white; font-weight: bold; font-family:Muslimah;font-size: 17px; ">Log out</a> </button>
        </div>
      </div>
    </div>
  </nav>
  ...
  <div class="container  sticky">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
      ...
      <ul class="nav col-lg-6 justify-content-end list-unstyled d-flex " >
        ...
        <li class="ms-3"style=" margin-left:8px;"><a style="color:#d44c75;" href="#"><svg xmlns="http://instagram.com/ultimate_international_academy?utm_medium=copy_link" width="20" height="20" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
