...
$job=$_POST['inlineRadioOptions'];

// Database connection
$conn = new mysqli("localhost","root","","uiadb");
...
die("Connection Failed : ". $conn->connect_error);
  ...
  if($job=="Student"){
    $stmt = $conn->prepare("select * from uia_student where StudentName = ? ");
    ...
    $stmt = $conn->prepare("select * from uia_teacher where TeacherName = ? "); //ربط الاستاذ
    $stmt->bind_param("s",$Username);
  // $stmt->store_result();
    $stmt->execute();
  $stmt_result=$stmt->get_result();
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky " style="position: -webkit-sticky;position: sticky;top: 0; z-index:1; background-color: #F1F1F4; box-shadow: 0 2px 5px 0 rgb(0 0 0 / 16%), 0 2px 10px 0 rgb(0 0 0 / 12%); border-bottom:1px solid #000000; box-sizing: inherit;" >
        <div class="container-fluid col-3 mx-auto">
          <a class="navbar-brand" href="Home.php">
            <img src="img/logo1.png" alt="" width="70" height="90">
             <img src="img/name.png" alt=""  width="220" height="40" >
          </a>
        </div>
    </nav>

    <div class="container w-50 mt-5">
        <form action="" method="POST" style="border: 2px solid rgb(102, 99, 99); border-radius: 20px; padding:30px;">
            <!-- <u style="color: lightslategrey; height:1px;"></u> -->
            <h2 style="text-align: center; font-weight: bold;  font-family: Georgia, Times, serif; color: rgb(218, 11, 11); margin-bottom: 30px;"> Login</h2>
            
            <br/>
            <div class="row col-md-6  mx-auto" style="margin-bottom:30px; font-weight: bold;  font-family: Georgia, Times, serif;">
            ...
            <div class="form-group col-md-6  mx-auto">
                <label  style="font-weight: bold;  font-family: Georgia, Times, serif;">Username</label>
                <input placeholder="اسم المستخدم" class="form-control" type="text" name="name">
                <!-- <small class="form-text text-muted"> Enter your full name / ادخل إسمك الرباعي</small> -->
            </div>

            <div class="form-group col-md-6  mx-auto ">
              <label  style="font-weight: bold;  font-family: Georgia, Times, serif;">Password</label>
              <input placeholder="كلمة المرور"  class="form-control" type="password"  name="Passwo">
              <div style="padding-top:10px ; font-family: Georgia, Times, serif;">
                <!-- Forgot password -->
        ...
        <div class="d-grid gap-2 col-8 mx-auto" style="font-weight: bold; font-family: Georgia, Times, serif;">
          <button class="btn" style="width:100%; background: #050569; color:#FFFFFF; border:2px solid #aa9b9b; border-radius: 20px; padding: 10px; "><a href="Teacher Page.php">Login</a> </button>
        </div>
            
        </form>
        <br/>

        <span style=" font-family: Georgia, Times, serif;">Need an account? <span style=" font-family: Georgia, Times, serif;"><a href="Sign in .php"> Sign up</a></span> </span>
