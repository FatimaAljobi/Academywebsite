...
die("Connection Failed : ". $conn->connect_error);
  ...
  $stmt = $conn->prepare("select * from uia_student where StudentName = ? && StudentID =?");
  ...
  <div class="container w-50 mt-5">
    <form action="" method="POST" style="border: 2px solid rgb(102, 99, 99); border-radius: 20px; padding:30px;"  >   
      ...
      <div class="form-group col-md-6  mx-auto" >
        ...
        <input placeholder="اسم المستخدم" class="form-control" type="text" name="Username">
      </div>

      <div class="form-group col-md-6  mx-auto " >
        <label  style="font-weight: bold;  font-family: Georgia, Times, serif;">Password</label>
        <input placeholder="كلمة المرور"  class="form-control" type="password"  name="Password">
      </div>
      <br/>
      <div class="d-grid gap-2 col-8 mx-auto" style="font-weight: bold; font-family: Georgia, Times, serif;">
        <a href="Home.php"><button name="Login"  class="btn" style="width:100%; background: #050569; color:#FFFFFF; border:2px solid #aa9b9b; border-radius: 20px; padding: 10px; ">Login</button></a>
      </div>   
    </form>
    <br/>
  </div>
