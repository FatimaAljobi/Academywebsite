...
<!--Events-->
<div class="card-header " style="margin-top: 50px; margin-bottom: 50px; margin-left:70px; margin-right: 70px; border-radius:15px; text-align: center; background-color: #050569; color: white; font-weight: bold; font-family:Muslimah; font-size: 26px; ">
    Events
  </div>
  <div class="card mb-3" style=" margin-left:100px; margin-right: 100px;  ">
    <img src="img/2.jpg" style="width: 100%; height:650px;" class="card-img-top" alt="...">
    <!-- <div class="card-body">
  ...
  <div class="card mb-3" style=" margin-left:100px; margin-right: 100px; margin-top:50px;">
    <img src="img/1.jpg" style="width: 100%; height:650px;" class="card-img-top" alt="...">
    <!-- <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card-header " style="margin-top: 50px; margin-bottom: 50px; margin-left:70px; margin-right: 70px; border-radius:15px; text-align: center; background-color: #050569; color: white; font-weight: bold; font-family:Muslimah; font-size: 26px; ">
  ...
  <div class="card mb-3" style=" margin-left:100px; margin-right: 100px; margin-top:50px;">
    <img src="img/1.jpg" class="card-img-top" style="width: 100%; height:650px;" >
    <!-- <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
